...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    // método para alterar registro de usuários
    private void alterar (){
        ...
        try {
            ...
            // a linha abaixo atualiza a tabela usuários com os dados do formulário 
            // a estrutura abaixo é usada para confirmar a alteração de dados do usuário na tabela
            int adicionado = pst.executeUpdate();
             // a linha abaixo serve de apoio para o entendimento da lógica
             //System.out.println(adicionado);
            if (adicionado > 0){
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtUsuFone, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
