...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    // a linha abaixo cria uma variável para armazenar um texto de acordo com o texto selecionado
    private String tipo;
    ...
    private void emitir_os() {
        ...
        try {
            ...
            // .replace substitui o ponto pela virgula
    ...
    private void pesquisar_os() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                //evitando problemas
                btnOsAdicionar.setEnabled(false);//Para evitar adicionar novamente dados de os que foram pesquisados e já estão no sistema
    ...
    private void initComponents() {
        ...
        btnOsImprimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/iconfinder_document-print_38984 (1).png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtOsTec, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
